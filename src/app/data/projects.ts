...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "An enterprise-grade villa booking system built on SharePoint with Power Apps integration.",
    category: "UX/UI",
    tags: ["SharePoint", "Power Apps"],
  ...
  },
  {
    ...
    description: "A specialized navigation app designed for motorbike riders with offline maps, weather updates, and route optimization.",
    category: "UX/UI",
    tags: ["Prototype", "Figma", "Google Maps API", "Axure"],
  ...
  },
  {
    ...
    category: "Full-Stack",
    tags: ["documentation", "collaboration", "reporting"],
